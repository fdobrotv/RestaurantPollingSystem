-- CREATE TABLE USERS (ID integer, EMAIL varchar(100), LOGIN varchar(100), FIO varchar(100), PASSWORD varchar(100), );
...
(0, TODAY(), 0), (1, '2016-10-28', 0),
(2, TODAY(), 1), (3, '2016-10-28', 1),
(4, TODAY(), 2), (5, '2016-10-28', 2);
